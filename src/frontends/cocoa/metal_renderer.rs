    ...
    pub fn run_scale_compute(
        ...
        let (idx, msl): (usize, &[u8]) = match filter {
            ScaleFilter::OmniScale => (
                0,
                include_bytes!(concat!(env!("OUT_DIR"), "/omniscale_comp.metal")),
            ),
            ScaleFilter::Epx | ScaleFilter::Scale2x | ScaleFilter::Scale4x => (
                1,
                include_bytes!(concat!(env!("OUT_DIR"), "/epx_comp.metal")),
            ),
            ScaleFilter::Eagle => (
                2,
                include_bytes!(concat!(env!("OUT_DIR"), "/eagle_comp.metal")),
            ),
            ScaleFilter::Scale3x => (
                3,
                include_bytes!(concat!(env!("OUT_DIR"), "/scale3x_comp.metal")),
            ),
            ScaleFilter::Bicubic => (
                4,
                include_bytes!(concat!(env!("OUT_DIR"), "/bicubic_comp.metal")),
            ),
            ScaleFilter::NearestAa => (
                5,
                include_bytes!(concat!(env!("OUT_DIR"), "/nearest_aa_comp.metal")),
            ),
            ScaleFilter::Hqx(_) => (
                6,
                include_bytes!(concat!(env!("OUT_DIR"), "/hqx_comp.metal")),
            ),
            ScaleFilter::Xbr(_) => (
                7,
                include_bytes!(concat!(env!("OUT_DIR"), "/xbr_comp.metal")),
            ),
            ScaleFilter::Xbrz(_) => (
                8,
                include_bytes!(concat!(env!("OUT_DIR"), "/xbrz_comp.metal")),
            ),
            ScaleFilter::OmniScaleLegacy => (
                9,
                include_bytes!(concat!(env!("OUT_DIR"), "/omniscale_legacy_comp.metal")),
            ),
            ScaleFilter::SuperXbr => return self.run_super_xbr_compute(pixels, src_w, src_h),
            ScaleFilter::Edi => (
                11,
                include_bytes!(concat!(env!("OUT_DIR"), "/edi_comp.metal")),
            ),
            ScaleFilter::Nedi => (
                12,
                include_bytes!(concat!(env!("OUT_DIR"), "/nedi_comp.metal")),
            ),
            ScaleFilter::Dcci => (
                13,
                include_bytes!(concat!(env!("OUT_DIR"), "/dcci_comp.metal")),
            ),
            ScaleFilter::Mmpx => (
                14,
                include_bytes!(concat!(env!("OUT_DIR"), "/mmpx_comp.metal")),
            ),
            ScaleFilter::LcdGrid => (
                15,
                include_bytes!(concat!(env!("OUT_DIR"), "/lcd_grid_comp.metal")),
            ),
            ScaleFilter::Nearest => (
                16,
                include_bytes!(concat!(env!("OUT_DIR"), "/nearest_comp.metal")),
            ),
            ScaleFilter::Bilinear => (
                17,
                include_bytes!(concat!(env!("OUT_DIR"), "/bilinear_comp.metal")),
            ),
            ScaleFilter::Sai2x => (
                18,
                include_bytes!(concat!(env!("OUT_DIR"), "/sai2x_comp.metal")),
            ),
            ScaleFilter::Super2xSai => (
                19,
                include_bytes!(concat!(env!("OUT_DIR"), "/super_sai2x_comp.metal")),
            ),
            ScaleFilter::SuperEagle => (
                20,
                include_bytes!(concat!(env!("OUT_DIR"), "/super_eagle_comp.metal")),
            ),
        ...
        let (out_w, out_h) = match filter {
            ...
            | ScaleFilter::Sai2x
            | ScaleFilter::Super2xSai
            | ScaleFilter::SuperEagle => (src_w * 2, src_h * 2),
