/// PPU I/O register read/write, VRAM/OAM access, palette sync, retroactive fixes.
...
impl Ppu {
    ...
    pub(super) fn retroactive_palette_fix(&mut self, pal_type: u8, old_val: u8, new_val: u8) {
