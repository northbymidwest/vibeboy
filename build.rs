...
const SHADERS: &[ShaderInfo] = &[
    ...
    // ── Scaling filter compute shaders ──────────────────────────────────
    ShaderInfo {
        glsl_src: "epx.comp",
        spv_name: "epx_comp.spv",
        msl_name: "epx_comp.metal",
        dxil_name: "epx_comp.dxil",
        wgsl_name: "epx_comp.wgsl",
        // spirv-cross: buffer(0)=uniforms, buffer(1)=pixels — matches SDL3 convention
        msl_buffer_remap: &[],
    },
    ShaderInfo {
        glsl_src: "eagle.comp",
        spv_name: "eagle_comp.spv",
        msl_name: "eagle_comp.metal",
        dxil_name: "eagle_comp.dxil",
        wgsl_name: "eagle_comp.wgsl",
        msl_buffer_remap: &[],
    },
    ShaderInfo {
        glsl_src: "scale3x.comp",
        spv_name: "scale3x_comp.spv",
        msl_name: "scale3x_comp.metal",
        dxil_name: "scale3x_comp.dxil",
        wgsl_name: "scale3x_comp.wgsl",
        msl_buffer_remap: &[],
    },
    ShaderInfo {
        glsl_src: "bicubic.comp",
        spv_name: "bicubic_comp.spv",
        msl_name: "bicubic_comp.metal",
        dxil_name: "bicubic_comp.dxil",
        wgsl_name: "bicubic_comp.wgsl",
        msl_buffer_remap: &[],
    },
    ShaderInfo {
    ...
    ShaderInfo {
        glsl_src: "omniscale.comp",
        spv_name: "omniscale_comp.spv",
        msl_name: "omniscale_comp.metal",
        dxil_name: "omniscale_comp.dxil",
        wgsl_name: "omniscale_comp.wgsl",
        // spirv-cross: buffer(0)=uniforms, buffer(1)=pixels — matches SDL3 convention
        msl_buffer_remap: &[],
    },
    ShaderInfo {
        glsl_src: "hqx.comp",
        spv_name: "hqx_comp.spv",
        msl_name: "hqx_comp.metal",
        dxil_name: "hqx_comp.dxil",
        wgsl_name: "hqx_comp.wgsl",
        msl_buffer_remap: &[],
    },
    ShaderInfo {
        glsl_src: "xbr.comp",
        spv_name: "xbr_comp.spv",
        msl_name: "xbr_comp.metal",
        dxil_name: "xbr_comp.dxil",
        wgsl_name: "xbr_comp.wgsl",
        msl_buffer_remap: &[],
    },
    ShaderInfo {
        glsl_src: "xbrz.comp",
        spv_name: "xbrz_comp.spv",
        msl_name: "xbrz_comp.metal",
        dxil_name: "xbrz_comp.dxil",
        wgsl_name: "xbrz_comp.wgsl",
        msl_buffer_remap: &[],
    },
    ShaderInfo {
        glsl_src: "super_xbr.comp",
        spv_name: "super_xbr_comp.spv",
        msl_name: "super_xbr_comp.metal",
        dxil_name: "super_xbr_comp.dxil",
        wgsl_name: "super_xbr_comp.wgsl",
        msl_buffer_remap: &[],
    },
    ShaderInfo {
        glsl_src: "omniscale_legacy.comp",
        spv_name: "omniscale_legacy_comp.spv",
        msl_name: "omniscale_legacy_comp.metal",
        dxil_name: "omniscale_legacy_comp.dxil",
